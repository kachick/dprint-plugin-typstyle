...
[![npm version](https://img.shields.io/npm/v/@kachick/dprint-plugin-typstyle.svg)](https://www.npmjs.com/package/@kachick/dprint-plugin-typstyle) [![CI - Nix Status](https://github.com/kachick/dprint-plugin-typstyle/actions/workflows/nix.yml/badge.svg?branch=main)](https://github.com/kachick/dprint-plugin-typstyle/actions/workflows/nix.yml?query=branch%3Amain+)
...
| wrapMode               | `none`               | wrap_mode               | wrap-text (`none`/`fill`/`sentence`) |
